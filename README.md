...
[![Acessar Portfólio](https://img.shields.io/badge/Acessar%20Site-GitHub%20Pages-22D4FD?style=for-the-badge&logo=github&logoColor=black)](https://gabrie1tk.github.io/Atividade11_FrontEnd/)
...
* **Página Inicial (`index.html`):** Apresentação profissional ("Eleve seu negócio digital a outro nível"), destacando especialidades como HTML, CSS e JavaScript.
* **Página de Portfólio (`portfolio.html`):** Galeria visual dedicada à exibição de projetos realizados.

### Principais Aprendizados:
* **Flexbox:** Utilizado para alinhar elementos do cabeçalho e distribuir o conteúdo principal lado a lado com a imagem.
...
1.  **Clone o repositório:**
    ```bash
    git clone [https://github.com/Gabrie1Tk/Atividade11_FrontEnd.git](https://github.com/Gabrie1Tk/Atividade11_FrontEnd.git)
    ```
2.  **Acesse a pasta:**
